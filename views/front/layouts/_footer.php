      ...
      <div class="row f_widgets_inner">
         <div class="col-lg-4 col-md-6 col-sm-6">
            <div class="single-footer-widget ab_widgets">
               <div class="f_title">
                  <h3>MaulanaNews.com</h3>
               </div>
               <p>MaulanaNews merupakan portal berita kekinian</p>
            </div>
         </div>
         <div class="col-lg-4 col-md-6 col-sm-6">
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Maulana</a>
