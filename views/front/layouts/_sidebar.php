<div class="col-lg-4">
   <div class="right_sidebar">
      ...
      <aside class="r_widgets social_widgets mt-5">
         ...
         <ul class="list">
            <li><a href="#"><i class="fa fa-facebook"></i>Maulana.com<span>Like our page</span></a></li>
            <li><a href="#"><i class="fa fa-twitter"></i>Maulana.com<span>Follow Us</span></a></li>
            <li><a href="#"><i class="fa fa-youtube-play"></i>Maulana.com<span>Subscribe</span></a></li>
         </ul>
      </aside>
